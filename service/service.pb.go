...
func (x *ValueReturn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValueReturn) ProtoMessage() {}

func (x *ValueReturn) ProtoReflect() protoreflect.Message {
	mi := &file_service_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValueReturn.ProtoReflect.Descriptor instead.
func (*ValueReturn) Descriptor() ([]byte, []int) {
	return file_service_service_proto_rawDescGZIP(), []int{1}
}

func (x *ValueReturn) GetValue() int32 {
	if x != nil {
		return x.Value
	}
	return 0
...
var file_service_service_proto_rawDesc = []byte{
	...
	,
...
var file_service_service_proto_goTypes = []interface{}{
	...
	(*ValueReturn)(nil),      // 1: service.ValueReturn
}
var file_service_service_proto_depIdxs = []int32{
	0, // 0: service.IncrementService.Increment:input_type -> service.IncrementRequest
	1, // 1: service.IncrementService.Increment:output_type -> service.ValueReturn
