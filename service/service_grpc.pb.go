...
type IncrementServiceClient interface {
	Increment(ctx context.Context, in *IncrementRequest, opts ...grpc.CallOption) (*ValueReturn, error)
}
...
func (c *incrementServiceClient) Increment(ctx context.Context, in *IncrementRequest, opts ...grpc.CallOption) (*ValueReturn, error) {
	out := new(ValueReturn)
	err := c.cc.Invoke(ctx, "/service.IncrementService/Increment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IncrementServiceServer interface {
	Increment(context.Context, *IncrementRequest) (*ValueReturn, error)
...
func (UnimplementedIncrementServiceServer) Increment(context.Context, *IncrementRequest) (*ValueReturn, error) {
...
func _IncrementService_Increment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.IncrementService/Increment",
	}
...
var IncrementService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.IncrementService",
